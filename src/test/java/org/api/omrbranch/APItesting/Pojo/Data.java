...
//////Input
	...
	public ArrayList<UserRole> getUser_role() {
		return user_role;
	}
	public void setUser_role(ArrayList<UserRole> user_role) {
	...
	public String getTravel_access() {
		return travel_access;
	}
	public void setTravel_access(String travel_access) {
		this.travel_access = travel_access;
	}
	public String getGrocery_front_access() {
		return grocery_front_access;
	}
	public void setGrocery_front_access(String grocery_front_access) {
		this.grocery_front_access = grocery_front_access;
	}
	public String getTravel_with_api_access() {
		return travel_with_api_access;
	}
	public void setTravel_with_api_access(String travel_with_api_access) {
		this.travel_with_api_access = travel_with_api_access;
	}
	public String getSample_api_access() {
		return sample_api_access;
	}
	public void setSample_api_access(String sample_api_access) {
		this.sample_api_access = sample_api_access;
	}
	public String getDatabase_access() {
		return database_access;
	}
	public void setDatabase_access(String database_access) {
		this.database_access = database_access;
	}
	public String getAdmin_panel_access() {
		return admin_panel_access;
	}
	public void setAdmin_panel_access(String admin_panel_access) {
		this.admin_panel_access = admin_panel_access;
	}
